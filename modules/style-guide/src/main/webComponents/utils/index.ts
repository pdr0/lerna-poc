// https://github.com/ionic-team/ionic/blob/master/react/src/components/utils/index.ts
/**
...
export function attachEventProps<E extends HTMLElement>(node: E, props: any, syncEvents: Array<string>) {
    Object.keys(props).forEach(name => {
        ...
        if (name.indexOf("on") === 0 && name[2] === name[2].toUpperCase()) {
            ...
            if (syncEvents.includes(eventName) || !isCoveredByReact(eventNameLc)) {
...
export function generateUniqueId() {
    return ([1e7].toString() + -(1e3).toString() + -(4e3).toString() + -(8e3).toString() + -(1e11).toString()).replace(
        /[018]/g,
        function(c: any) {
